...
public class CouponsController 
{
	...
	public Coupons updateCoupon(@PathVariable(value= "id") String id,@RequestBody Coupons coupon)
	{
		...
		obj.setStorePhotoUrl(coupon.getStorePhotoUrl());
		obj.setOffPercentage(coupon.getOffPercentage());
		obj.setDescription(coupon.getDescription());
		obj.setCategory(coupon.getCategory());
		obj.setSubcategory(coupon.getSubcategory());
		obj.setDate(coupon.getDate());
		obj.setTime(coupon.getTime());
		obj.setCouponCode(coupon.getCouponCode());
		obj.setCouponLink(coupon.getCouponLink());
